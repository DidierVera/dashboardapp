...
fun ElementModel.ColumnModel.toDto(): ElementDto.ColumnDto{
    return ElementDto.ColumnDto(
        elementType = "column",
        data = ColumnDataDto(
            dataKey = data.dataKey, validValue = data.validValue, ditTypeCode = data.ditTypeCode, spacing = data.spacing,
