...
import com.came.parkare.dashboardapp.ui.theme.Purple40
...
import dashboardapp.composeapp.generated.resources.ic_add_element
...
import dashboardapp.composeapp.generated.resources.ic_template
        ...
        Row(horizontalArrangement = Arrangement.SpaceBetween,
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(4.dp)) {
                TooltipButton(onClick = {viewModel.displayBlankElement()},
                    ...
                    Icon(if(state.displayBlankElements) painterResource(Res.drawable.ic_close) else painterResource(Res.drawable.ic_add_element),
                        contentDescription = null, modifier = Modifier.size(24.dp), tint = Purple40)
                }
                TooltipButton(onClick = {viewModel.displayElements()},
                    tooltipTextId = Res.string.default_elements_label){
                    Icon(if(state.displayDefaultElements) painterResource(Res.drawable.ic_close) else painterResource(Res.drawable.ic_shapes),
                        contentDescription = null, modifier = Modifier.size(24.dp), tint = Purple40)
                }
                TooltipButton(onClick = {viewModel.displayDefaultScreens()},
                    tooltipTextId = Res.string.default_screens_label){
                    Icon(if(state.displayDefaultScreens) painterResource(Res.drawable.ic_close) else painterResource(Res.drawable.ic_template),
                        contentDescription = null, modifier = Modifier.size(24.dp), tint = Purple40)
                }
            }
