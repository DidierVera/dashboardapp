...
import dashboardapp.composeapp.generated.resources.value_label
...
@Composable
fun SpacerProperties(
    spacer: SpacerDataDto,
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        OutlinedTextField(
            ...
            label = { Text(stringResource(Res.string.value_label)) }
        )


        Button(
            onClick = {
                val updatedBox = ElementDto.SpacerDto(
                    elementType = "spacer",
                    data = spacer.copy(
                        value = value.toInt()
                    ))
